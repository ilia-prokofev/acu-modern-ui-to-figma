...
export default class ChildrenVisitor {
    ...
    public populate(visitors: ElementVisitor[]): void {
        for (const visitor of visitors) {
            this.visitors.push(visitor);
        }
    }

    public visitChildren(htmlElement: Element, parent: AcuElement): void {
    ...
    public visit(htmlElement: Element, parent: AcuElement): void {
        if (findClasses(htmlElement, 'aurelia-hide')) {
            return;
        }
